    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className={`relative w-full ${maxWidth} bg-white dark:bg-slate-900 rounded-2xl border border-gray-200 dark:border-white/10 shadow-2xl`}>
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-white/10">
          ...
          <button
            onClick={onClose}
            className="ml-auto p-1.5 rounded-lg text-gray-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
